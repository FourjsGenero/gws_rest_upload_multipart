@rem
@rem FOURJS_START_COPYRIGHT(U,2015)
@rem Property of Four Js*
@rem (c) Copyright Four Js 2015, 2015. All Rights Reserved.
...
fglcomp FileUploadService.4gl
call fgllink -o FileUploadService.42r FileUploadService.42m
